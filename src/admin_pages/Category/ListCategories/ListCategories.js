...
import { deleteCategory } from '~/api_services/categoryServices'
...
function ListCategories() {
    ...
    useLayoutEffect(() => {
        ...
        const data = categories.filter(function (category) {
    ...
    return (
        <div className={cx('wrapper')}>
            <div className={cx('title')}>Danh sách danh mục</div>
            <Dialog
                open={openDialog}
                onClose={handleClose}
            ...
            <div className={cx('btn-group')}>
                <div className={cx('btn')}>
                    <Button primary to={admin.newCategory}>
                        Thêm danh mục
                    </Button>
            ...
            <div className={cx('content')}>
                <div className={cx('header')}>
                    ...
                    <div className={cx('collumn-item')}>Tên danh mục</div>
                    <div className={cx('collumn-item', 'image-item')}>Thumbnails</div>
                    ...
                    <div className={cx('list-categories')}>
                        {searchResults.map((category, index) => (
                            <CategoryItem
                                ...
                                handleChecked={(e) => handleChecked(category.id, e)}
                            />
                        ))}
                    </div>
                </div>
