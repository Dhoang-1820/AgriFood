export const UserIcon = ({ width = '3rem', height = '3rem', className }) => (
    <svg className={className} viewBox='0 0 16 16' width={width} height={height} fill='currentColor'>
...
export const CartIcon = ({ width = '2.6rem', height = '2.6rem', className }) => (
    <svg
        className={className}
...
export const MapMakerIcon = ({ width = '3rem', height = '3rem', className }) => (
    <svg
        className={className}
        xmlns='http://www.w3.org/2000/svg'
        viewBox='0 0 16 16'
...
export const UserSolidIcon = ({ width = '2rem', height = '2rem ', className }) => (
    <svg
        className={className}
        xmlns='http://www.w3.org/2000/svg'
        viewBox='0 0 16 16'
...
export const BarIcon = ({ width = '2.4rem', height = '2.4rem ', className, onMouseOver }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const WarningIconOuLine = ({ width = '9rem', height = '9rem ', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const BellIcon = ({ width = '3.5rem', height = '3.5rem ', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const ArrowUpIcon = ({ width = '3.5rem', height = '3.5rem ', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
