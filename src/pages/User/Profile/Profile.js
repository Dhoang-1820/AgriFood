        ...
        <User>
            <div className={cx('wrapper')}>
                ...
                <Box
                    component='form'
                    sx={{
                        '& .MuiInputLabel-root, .MuiOutlinedInput-root, .MuiAutocomplete-option': {
                            fontSize: '1.4rem',
                        },
                        // '& .MuiOutlinedInput-root': { fontSize: '1.4rem' },
                        // '& .MuiAutocomplete-option': { fontSize: '1.4rem' },
                        '& .MuiAutocomplete-root': { width: '100%' },
                        '& .MuiFormHelperText-root, .MuiFormControlLabel-label, .MuiPaper-elevation': {
                            fontSize: '1.3rem',
                        },
                ...
                >
                    <div className={cx('user-infor')}>
                        <div className={cx('infor-item')}>
                            <label htmlFor='fullName' className={cx('user-label')}>
                                Họ tên
                        ...
                        <div className={cx('infor-item')}>
                            <label htmlFor='email' className={cx('user-label')}>
                                Địa chỉ email
                            </label>
                        ...
                        <div className={cx('infor-item')}>
                            <label htmlFor='districts' className={cx('user-label')}>
                                Quận/Huyện
                                <span className={cx('red-text')}>*</span>
                            </label>
                            <Autocomplete
                        ...
                        <div className={cx('infor-item')}>
                            <label htmlFor='commune' className={cx('user-label')}>
                                Phường/Xã
                                <span className={cx('red-text')}>*</span>
                            </label>
                            <Autocomplete
                        ...
                        <div className={cx('infor-item')}>
                            <label htmlFor='houseNumber' className={cx('user-label')}>
                                Số nhà, tên đường
                                <span className={cx('red-text')}>*</span>
                            </label>
                            <TextField
